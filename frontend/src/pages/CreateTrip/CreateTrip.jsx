...
const CreateTrip = () => {
  ...
  const [form, setForm] = useState({
    tripName: '', destination: '', country: '',
    startDate: '', endDate: '',
    climate: '', tripType: '', luggageType: '',
  });
  ...
  const submit = () => {
    console.log('New trip:', { ...form, durationDays: duration(), status: 'planning', items: [] });
    navigate('/dashboard');
  };
        ...
        <div className={styles.stepper}>
          {STEPS.map((s, i) => (
            <div key={s} className={styles.stepItem}>
              ...
              <span className={`${styles.stepLabel} ${i === step ? styles.stepLabelOn : ''}`}>{s}</span>
              {i < STEPS.length - 1 && (
        ...
        <div className={styles.card}>
          ...
          {step === 0 && (
            <div className={styles.formStep}>
              ...
              <div className={styles.field}>
                ...
                <input id="tripName" className={`${styles.input} ${errors.tripName ? styles.inputErr : ''}`}
                  type="text" placeholder="e.g. Tokyo Winter Escape"
              ...
              <div className={styles.row2}>
                <div className={styles.field}>
                  ...
                  <input id="destination" className={`${styles.input} ${errors.destination ? styles.inputErr : ''}`}
                ...
                <div className={styles.field}>
                  ...
                  <input id="country" className={`${styles.input} ${errors.country ? styles.inputErr : ''}`}
              ...
              <div className={styles.row2}>
                <div className={styles.field}>
                  ...
                  <input id="startDate" className={`${styles.input} ${errors.startDate ? styles.inputErr : ''}`}
                ...
                <div className={styles.field}>
                  ...
                  <input id="endDate" className={`${styles.input} ${errors.endDate ? styles.inputErr : ''}`}
              ...
              {duration() && (
                <span className={styles.durationPill}>📅 {duration()} day{duration() !== 1 ? 's' : ''}</span>
              )}
            </div>
          )}
              ...
              <div className={styles.preview}>
                <div className={styles.previewTop}>
                  ...
                  <div>
                    ...
                    <p className={styles.previewDest}>{form.destination}, {form.country}</p>
                  </div>
                </div>
          ...
          <div className={styles.nav}>
            ...
            {step < STEPS.length - 1
              ...
              : <button className={styles.submitBtn} onClick={submit}>Create trip →</button>
            }
          </div>
        </div>
