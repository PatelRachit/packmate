...
const homeCities = ["Boston", "New York", "Chicago", "Los Angeles", "Seattle", "Austin", "Miami", "Denver"];
...
const firstNames = ["Sarah", "Marcus", "Priya", "Alex", "Jordan", "Taylor", "Morgan", "Casey", "Riley", "Jamie", "Chris", "Sam", "Drew", "Blake", "Quinn"];
const lastNames = ["Chen", "Lee", "Patel", "Smith", "Johnson", "Williams", "Brown", "Jones", "Garcia", "Miller", "Davis", "Wilson", "Moore", "Taylor", "Anderson"];
...
async function seed() {
  try {
    ...
    console.log("Seeding complete! Total records: " + (users.length + tips.length));
  } catch (err) {
